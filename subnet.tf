...
resource "aws_subnet" "shan_subnet" {
  vpc_id     = aws_vpc.shan_vpc.id #this subnet need to map with my vpc
...
map_public_ip_on_launch = true
  tags = {
    Name = "shan-public-subnet-${each.key}" #it will create the name of the subnet with the respective availability zone
  }
}
